...
public class Phase1
{
   ...
   private static void restartButtonAction(ActionEvent evt)
   {
      ...
      if (str.equals("Restart"))
      {
         ...
         {
            gameIndex = 0;
            Phase1.myCardTable.setVisible(false);
            setFrame();
            Phase1.myCardTable.setVisible(true);
            Phase1.restartButton.setVisible(false);
...
class DisplayWinner extends JPanel
{
   ...
   public void paint(Graphics g)
   {
      ...
      if (Phase1.highCardGame.getNumCardsRemainingInDeck() == 0)
      {
      ...
      if (x == 350)
      {
         ...
         Phase1.winner.setVisible(false);
         Phase1.restartButton.setVisible(true);
         Phase1.exitButton.setVisible(true);
         Phase1.getBottomPanel().add(Phase1.buttonsPanel, BorderLayout.CENTER);
         return;
      }
