...
public class Phase3
{
   ...
   {
      public static CardGameFramework buildCardGame;
      ...
      private static boolean computerPlaysFirst = false;
      private static CardModel.Card selectedCard = null;
      ...
      private static void startTheGame()
      {
         ...
         System.out.println(buildCardGame.getHand(0).toString());
         ...
         if (cardsClickable)
         {
            ...
            for (int i = 0; i < NUM_CARDS_PER_HAND; i++)
            {
               if (e.getSource() == humanLabels[i])
               {
                  ...
                  selectedCard = buildCardGame.selectCard(1, handIndex);
       ...
       *           the event
       */
      private static void skipButtonAction(ActionEvent evt)
      {
         cardsClickable = false;
         skipButton.setEnabled(false);
      ...
      static class CardGameFramework
      {
         ...
         public boolean deal()
         {
            ...
            cardPlayed[0] = deck.dealCard();
            cardPlayed[1] = deck.dealCard();
         ...
         public CardModel.Card selectCard(int playerIndex, int cardIndex)
         {
            ...
            CardModel.Card card = hand[playerIndex].inspectCard(cardIndex);
